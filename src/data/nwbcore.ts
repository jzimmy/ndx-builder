  ...
  const catalog: { [keyof: string]: Spec.CoreType } = {
    ...
    ImageReferences: [
      "DATASET",
      {
        ...
        get dtype() {
          return ["REFSPEC", coreQueryAsNWBType("Image")] as Spec.Dtype;
        },
      },
    ],
  };
...
export const modules: { [keyof: string]: CoreTypeId[] } = {
  retinotopy: [["GROUP", "ImagingRetinotopy"]],
  icephys: [
    ["GROUP", "PatchClampSeries"],
    ["GROUP", "CurrentClampSeries"],
    ["GROUP", "IZeroClampSeries"],
    ["GROUP", "CurrentClampStimulusSeries"],
    ["GROUP", "VoltageClampSeries"],
    ["GROUP", "VoltageClampStimulusSeries"],
    ["GROUP", "IntracellularElectrode"],
    ["GROUP", "SweepTable"],
    ["GROUP", "IntracellularElectrodesTable"],
    ["GROUP", "IntracellularStimuliTable"],
    ["GROUP", "IntracellularResponsesTable"],
    ["GROUP", "IntracellularRecordingsTable"],
    ["GROUP", "SimultaneousRecordingsTable"],
    ["GROUP", "SequentialRecordingsTable"],
    ["GROUP", "RepetitionsTable"],
    ["GROUP", "ExperimentalConditionsTable"],
  ],
  behavior: [
    ["GROUP", "SpatialSeries"],
    ["GROUP", "BehavioralEpochs"],
    ["GROUP", "BehavioralEvents"],
  ...
  misc: [
    ["GROUP", "AbstractFeatureSeries"],
    ["GROUP", "AnnotationSeries"],
    ["GROUP", "IntervalSeries"],
    ["GROUP", "DecompositionSeries"],
    ["GROUP", "Units"],
  ],
  file: [
    ["GROUP", "NWBFile"],
  ...
  ophys: [
    ["GROUP", "OnePhotonSeries"],
    ["GROUP", "TwoPhotonSeries"],
    ["GROUP", "RoiResponseSeries"],
    ["GROUP", "DfOverF"],
    ["GROUP", "Fluorescence"],
    ["GROUP", "ImageSegmentation"],
    ["GROUP", "PlaneSegmentation"],
    ["GROUP", "ImagingPlane"],
    ["GROUP", "OpticalChannel"],
    ["GROUP", "MotionCorrection"],
    ["GROUP", "CorrectedImageStack"],
  ],
  ecephys: [
    ["GROUP", "ElectricalSeries"],
    ["GROUP", "SpikeEventSeries"],
    ["GROUP", "FeatureExtraction"],
    ["GROUP", "EventDetection"],
    ["GROUP", "EventWaveform"],
    ["GROUP", "FilteredEphys"],
    ["GROUP", "LFP"],
    ["GROUP", "ElectrodeGroup"],
    ["GROUP", "ClusterWaveforms"],
    ["GROUP", "Clustering"],
  ],
  image: [
    ["GROUP", "ImageSeries"],
    ["GROUP", "ImageMaskSeries"],
    ["GROUP", "OpticalSeries"],
    ["GROUP", "IndexSeries"],
    ["DATASET", "GrayscaleImage"],
    ["DATASET", "RGBImage"],
    ["DATASET", "RGBAImage"],
  ],
  ogen: [
    ["GROUP", "OptogeneticSeries"],
    ["GROUP", "OptogeneticStimulusSite"],
  ],
  epoch: [["GROUP", "TimeIntervals"]],
  device: [["GROUP", "Device"]],
  base: [
    ["GROUP", "NWBContainer"],
    ["GROUP", "NWBDataInterface"],
    ["GROUP", "TimeSeries"],
    ["GROUP", "ProcessingModule"],
    ["GROUP", "Images"],
    ["DATASET", "NWBData"],
    ["DATASET", "TimeSeriesReferenceVectorData"],
    ["DATASET", "Image"],
    ["DATASET", "ImageReferences"],
  ],
};
